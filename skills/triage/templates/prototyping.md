...
> Project playbook for this repo. The triage `prototype` subskill reads this file for the technique; the gates are in the skill's `reference/prototype.md`. The two shapes below are the shipped default (adapted from Matt Pocock's `prototype` skill, MIT) — tailor the **This repo** section; replace the technique if this team prototypes differently.
...
- Task runner and how to register a script: _<add yours>_.
- Routing convention and where shared UI lives: _<add yours>_.
- Component library / styling system variants must use: _<add yours>_.
