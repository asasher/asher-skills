...
4. **Approved** — the rendered plan was presented through the surface in `docs/agents/environment.md` § Presenting (contract: `reference/presenting.md`), the pause message carried its URL, and a human approved it as-is or a revised resubmission before any implementation begins. If approval changes scope, update the plan first.
