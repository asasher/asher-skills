...
- **Phase grouping:** a subtle zone rect (same pattern as architecture zone) behind each phase's rows, with an eyebrow label in the top-left margin. Use `rgba(237,237,237,0.02)` fill, `rgba(237,237,237,0.10)` stroke.
...
<rect x="X_start" y="ROW_Y+8" width="DURATION_PX" height="24" rx="4"
      fill="rgba(161,161,161,0.15)" stroke="#a1a1a1" stroke-width="1"/>
<text x="X_start+8" y="ROW_Y+25" fill="#ededed" font-size="10" font-weight="600"
