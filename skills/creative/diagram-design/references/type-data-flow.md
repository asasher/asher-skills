...
Default fill: `ink @ 0.12`, number text ink, label text muted. Focal fill: `accent @ 0.20`, number + label text accent. Per-step `color` override (§4): replaces the fill with `rgba(C, 0.20)` and the text fill with `C`.
