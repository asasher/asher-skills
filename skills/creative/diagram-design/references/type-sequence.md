...
<marker id="arrow-open" markerWidth="8" markerHeight="6" refX="7" refY="3" orient="auto">
  <polyline points="0 0, 8 3, 0 6" fill="none" stroke="#a1a1a1" stroke-width="1.2"/>
</marker>
```

Light mode: stroke `#666666` (muted on light paper). Do not fill the open marker — the hollow head is the async signal. Return messages keep the **filled** marker even when dashed.
...
Light mode: frame fill `rgba(23,23,23,0.04)`, stroke `rgba(23,23,23,0.22)`, tab fill = light `paper` (`#fafafa`), tab text = light `muted` (`#666666`).
...
<text x="X+12" y="GUARD_Y" fill="#a1a1a1" font-size="8"
      font-family="'Geist Mono', monospace" letter-spacing="0.04em">[token valid]</text>

<!-- alt region divider -->
<line x1="X+8" y1="DIV_Y" x2="X+W-8" y2="DIV_Y"
      stroke="rgba(237,237,237,0.20)" stroke-width="1" stroke-dasharray="4,3"/>
```
...
<line x1="CX" y1="TOP" x2="CX" y2="BOTTOM"
      stroke="rgba(237,237,237,0.20)" stroke-width="1" stroke-dasharray="3,3"/>
```
...
<rect x="CX-4" y="TOP" width="8" height="H"
      fill="rgba(237,237,237,0.06)" stroke="#a1a1a1" stroke-width="0.8"/>
```
