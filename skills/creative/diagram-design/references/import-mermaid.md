...
[`assets/example-import-mermaid.html`](../assets/example-import-mermaid.html) demonstrates a flowchart redraw at `format=html`, `size=doc-inline`, `detail=balanced`, `audience=mixed`.
