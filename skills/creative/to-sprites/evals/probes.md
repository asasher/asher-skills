...
`codex exec --sandbox read-only`, with `skills/creative/to-sprites/SKILL.md` in context plus the one referenced file
...
- **P1:** Run `python3 skills/creative/to-sprites/scripts/extract_spritesheet.py --in <sheet> --cols 4 --rows 4
