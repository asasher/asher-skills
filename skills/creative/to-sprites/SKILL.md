...
same dependency floor. Install with `pip install -r skills/creative/to-sprites/requirements.txt` when needed.
...
```sh
python3 skills/creative/to-sprites/scripts/extract_spritesheet.py \
