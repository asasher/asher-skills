...
Choose the complete explanation, retain qualifications, and remove failed starts, redundant takes, and distracting dead time. For a Short, select one self-contained takeaway with an ending. For a full explanation, keep examples needed to understand the claim.
