...
- Test framework, where the suite lives, and how to run a single test: _<add yours>_.
- Logging or debug entry points specific to this repo: _<add yours>_.
- Known flaky surfaces or hard-to-reproduce areas: _<add yours, or "none">_.
