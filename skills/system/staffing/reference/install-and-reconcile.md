...
Reachability state is per direction: **effect-verified**, **intentionally disabled**, or **unavailable** with a captured failure class — transient (carrying its retry-at when known) or durable — and successor. One failed direction never disables the healthy direction.
