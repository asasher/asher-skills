...
1. Inspect `git worktree list --porcelain`, local/remote refs, and the ticket's ownership record. Fetch the remote. Keep the primary checkout's branch and files unchanged.
