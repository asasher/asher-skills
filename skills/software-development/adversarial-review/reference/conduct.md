...
- Each pass addresses every finding it was dispatched with: a fix commit, or **pushback** — a reply giving the reason the finding is wrong. Disagreement is addressed; silence is not.
