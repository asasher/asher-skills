...
Keep the artifact effortless to launch and in memory unless persistence is the question. Stop once the artifact settles the question. Use the settled direction or validated behavior as the reference for implementation.
