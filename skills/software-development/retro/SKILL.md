...
4. **Execute local fixes.** A small binding fix (a playbook row, a denylist term) is proposed as a
   ...
   `capture` sibling; absent that sibling, present the items as a list the user can carry to
