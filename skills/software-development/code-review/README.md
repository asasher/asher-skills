...
baseline, repo overriding, everything a judgement call) and **Spec** (missing requirements, scope creep,
...
- **Bundled:** `reference/smells.md` — the smell baseline, pasted in full into the Standards brief.
...
- **Source:** Matt Pocock's MIT-licensed
  ...
  (two-axis structure, smell baseline, aggregation rules). License in `THIRD_PARTY_LICENSES.md`.
