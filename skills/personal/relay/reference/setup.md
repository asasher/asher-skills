...
Evidence providers are project data. A binding may name a stable path, command, connector, or optional sibling skill. Relay requires no sibling skill. Do not make any particular provider, mailbox, tracker, or repository layout universal.
