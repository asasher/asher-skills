...
Setup studies the consumer repository, confirms its choices, and materializes only `relay/` plus `docs/agents/relay.md`.
...
Bind evidence providers per repository using a stable path, command, connector, or optional sibling skill.
