...
<!-- Two to four lines. Each level must be checkable by the learner mid-session — a body test, an audible
     contrast, a question with a yes/no answer. If a level is never used after a pilot session, delete it. -->
