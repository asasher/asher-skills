...
| P3 | Invoke `capture-to-inbox setup` by name; that sibling owns every listed artifact/effect — control-plane does not duplicate its materialization, secret-storage, external dependency, deployment, or smoke-test logic (reference/setup.md step 1). |
