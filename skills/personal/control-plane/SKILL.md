...
argument-hint: "[setup | morning | relay | review-opportunities | projects-triage]"
user-invocable: true
...
metadata:
  ...
  optional: [projects-triage, relay, review-opportunities]
...
- **Siblings:** required `capture-to-inbox`, `manage-notes`, `manage-opportunities`, and `manage-tasks`;
  optional `relay`, `projects-triage`, and `review-opportunities`, all invoked by name without file imports.
