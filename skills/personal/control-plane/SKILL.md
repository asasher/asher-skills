...
argument-hint: "[setup | morning | runway | relay | review-opportunities | projects-triage]"
user-invocable: true
...
metadata:
  ...
  optional: [projects-triage, relay, review-opportunities, until-zero]
...
- **`relay`** - explicitly invoke the optional `relay` sibling for due project
...
- **Siblings:** required `capture-to-inbox`, `manage-notes`, `manage-opportunities`, and `manage-tasks`;
  optional `relay`, `projects-triage`, `review-opportunities`, and `until-zero`, all invoked by
