...
- **Event-driven:** `capture-to-inbox` drains and `manage-opportunities` mutations may run when their events
  occur; they keep their own idempotency and evidence gates.
