...
3. Ask whether morning ingest is enabled, which non-capture Intake sources participate, and whether any
   daily, weekly opportunity-review, or project-triage cadence should be scheduled.
