...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--instance", default="control-plane/runway", help=argparse.SUPPRESS)
    ...
    project_parser.add_argument("--instance", default="control-plane/runway")
    ...
    report_parser.add_argument("--instance", default="control-plane/runway")
    ...
    ingest_parser.add_argument("--instance", default="control-plane/runway")
    ...
    assign_parser.add_argument("--instance", default="control-plane/runway")
    ...
    propose_parser.add_argument("--instance", default="control-plane/runway")
    ...
    approve_parser.add_argument("--instance", default="control-plane/runway")
    ...
    apply_parser.add_argument("--instance", default="control-plane/runway")
    ...
    recover_parser.add_argument("--instance", default="control-plane/runway")
