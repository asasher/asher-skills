...
If the target structure is itself contested — more than one plausible shape, expensive to reverse — hand that question to the `prototype` skill (by name) before restructuring, and record the answer on the issue.
