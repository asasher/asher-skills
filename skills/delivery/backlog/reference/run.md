...
- While any issue is active, emit a heartbeat at most every 10 minutes: phase, last durable effect, next expected event.
...
4. Claim the queue.
   ...
   - Local tracker binding: follow `platform.md` § The local binding's **Commit-before-fork**; the claim commit is the fork point.
