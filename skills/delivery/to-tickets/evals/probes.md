...
**P1 (ac-1).** Read `skills/delivery/to-tickets/SKILL.md`. Does its frontmatter identify a user-invocable skill whose
...
**P11 (ac-11).** Read `skills/delivery/to-tickets/agents/openai.yaml`. Is it well-formed per
...
**P12 (ac-12).** Read `skills/delivery/to-tickets/evals/probes.md`. Does a pre-written answer key exist covering
