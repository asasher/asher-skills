...
All criteria passing proceeds, in the loop, to the create-PR step per `reference/build-loop.md`; standalone with a PR intended, continue to `reference/evidence.md` directly.
