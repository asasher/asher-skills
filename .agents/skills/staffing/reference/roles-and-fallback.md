...
- **One sibling harness direction fails** → mark only that route unavailable and re-run the same pins, gates, and ranking over the remaining reachable candidates. Symmetry is a property of two working directions, not an assumption.
