...
harnesses use the same one. Nothing about resolution differs here. (The machine-level `~/.claude/CLAUDE.md`
§ Staffing this section once superseded is retired — removed with asher-skills#114.)
