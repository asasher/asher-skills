# Published-skill provenance audit

Date: 2026-07-13

Relationship vocabulary and required notice handling follow the approved roadmap. “Original” means no copied
or adapted skill source was identified; intellectual bibliographies and invoked dependencies remain in their
existing READMEs.

| Skill(s) | Disposition |
|---|---|
| `diagnosing-bugs` | Adapted from Matt Pocock at immutable commit `04fee675…`; borrowed workflow, local changes, and exact MIT notice recorded. |
| `backlog`, `goodwork`, `learn-anything`, `setup-asher-skills`, `to-spec`, `to-tickets` | Matt-derived portions now name exact immutable files, borrowed material, local changes, and a shipped MIT notice. Backlog also preserves Cursor's MIT notice. |
| `eloquent` | Adapted/vendored from `Paramchoudhary/ResumeSkills@39e8356…`; exact relationship and MIT notice shipped. |
