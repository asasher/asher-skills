...
- Name the mechanism or the number ("`.toSQL()` returns the exact string sent to the database"). If a sentence cannot be restated as a concrete instruction, fact, or question, cut it.
